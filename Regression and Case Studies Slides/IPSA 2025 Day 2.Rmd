...
include_graphics("https://jnseawright.github.io/IPSA2025/Regression%20and%20Case%20Studies%20Slides/img/luputitleauthor.JPG")
```

---
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("https://jnseawright.github.io/IPSA2025/Regression%20and%20Case%20Studies%20Slides/img/lupu1.JPG")
```


---
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("https://jnseawright.github.io/IPSA2025/Regression%20and%20Case%20Studies%20Slides/img/lupu2.JPG")
```


---
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("https://jnseawright.github.io/IPSA2025/Regression%20and%20Case%20Studies%20Slides/img/lupu3.JPG")
```


---
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("https://jnseawright.github.io/IPSA2025/Regression%20and%20Case%20Studies%20Slides/img/lupu4.JPG")
```
...
---
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("https://jnseawright.github.io/IPSA2025/Regression%20and%20Case%20Studies%20Slides/img/aronowsamii1.JPG")
```


---
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("https://jnseawright.github.io/IPSA2025/Regression%20and%20Case%20Studies%20Slides/img/aronowsamii2.JPG")
```


---
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("https://jnseawright.github.io/IPSA2025/Regression%20and%20Case%20Studies%20Slides/img/aronowsamii3.JPG")
```
...
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("sima2023a.PNG")
```

---
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("sima2023b.PNG")
```
---

```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("sima2023c.PNG")
```

---
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("sima2023d.PNG")
```
