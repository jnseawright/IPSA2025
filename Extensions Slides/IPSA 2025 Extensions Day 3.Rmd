---
title: "Multi-Method Experiments"
...
include_graphics("img/cousinage1.jpg")
```
...
![image](img/jordanwomenexperiment.jpg)
...
```{r, echo = FALSE, out.width="70%", fig.retina = 1, fig.align='center'}
include_graphics("img/blmemotions.jpg")
```
...
include_graphics("img/blmpotus.jpg")
```
...
```{r, echo = FALSE, out.width="70%", fig.retina = 1, fig.align='center'}
include_graphics("img/russiafraud.jpg")
```
...
---
### "Lost" Cases and Selection Profiles


---
### Setting Up Our Own Experiment
...
---
![image](img/rootelementsperuviannation.jpg)
...
<figure>
<p><img src="img/Afroperuvian.jpg" alt="image" /><img
src="img/Indigenousman.jpg" alt="image" /><img src="img/Femalelawyer.jpg"
alt="image" /></p>
</figure>
